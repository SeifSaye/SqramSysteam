   ...
   client.on("message", message => {
    if (message.content === "<help--1") {
     const embed = new Discord.RichEmbed() 
         ...
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  نعتذر ولاكن لايوجد :heart: :scroll:
         :hearts: الموقع الرسمي للبوت نعتذر لاكن لايوجد: website here  :hearts: **`)
   ...
   client.on("message", message => {
    if (message.content === "<help-a") {
     const embed = new Discord.RichEmbed() 
         ...
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove: نعتذر ولاكن لايوجد :heart: :scroll:
         :hearts: الموقع الرسمي للبوت نعتذر ولاكن لايوجد: website here  :hearts: **`)
   message.author.sendEmbed(embed)
    ...
    if (message.content === "<help-p") {
     const embed = new Discord.RichEmbed() 
         .setThumbnail(message.author.avatarURL)
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  نعتذر ولاكن لايوجد :scroll:
         :hearts: الموقع الرسمي للبوت نعتذر ولاكن لايوجد: website here  :hearts: **`)
   message.author.sendEmbed(embed)
...
client.on('ready', function(){	
    var ms = 40000 ;	
    var setGame = ['ByiiLeget#0440','<help'];	
    var i = -1;	
    var j = 0;	
    setInterval(function (){	
        if( i == -1 ){	
...
حآول العبث بالسيرفر ${channel.guild.name}`)
 ...
 channelr[channelremover.id].deleted = 0;
  ...
  client.on('message', message => { 
    ...
    .setFooter(`BY Prosalr#7797`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
